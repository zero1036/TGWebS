...
iSlider = function () {
  ...
  iSlider.prototype._setting = function () {
    ...
    // Callback function when your finger tap the screen
    this.ontapend = opts.ontapend;
    ...
    // Callback function when the picture change
  ...
  iSlider.prototype.extend({
    addDot: function () {
      if (!this.isVertical) {
        ...
        this.wrap.parentNode.insertBefore(dotWrap,this.wrap);
